...
INSERT INTO `business_details` VALUES (18,1029,'Dhoble Mart','...',7756901721,'AB1234567808767','dhoblesaurabh35@gmail.com','','PLOT NO. 23, DHOBLE KIRANA STORES, MANISH NAGAR','NAGPUR','Maharashtra',440015,NULL),(26,1044,'Gada Electronics','Electronics and Accessories',6363636363,'542198546523251','sdfsd@gmail.com','','MANISH NAGAR','NAGPUR','Maharashtra',440015,'Seller%2F1044%2F26-photo.jpg'),(29,1048,'Tejas Shop','Electronics and Accessories',5216325298,'521325269875465','tejas@gmail.com','','SUJAYNAGAR 8 , BYPASS ROAD,','Akluj','Maharashtra',413101,'Seller%2F1048%2F29-photo.PNG');
...
CREATE TABLE `inventory` (
  ...
  `iDeliveryCharges` int DEFAULT '0',
  PRIMARY KEY (`iId`),
...
INSERT INTO `inventory` VALUES (100027,14500,100,1029,50026,'Y',NULL,'6GB 128GB',60),(100031,13000,15,1029,50031,'Y',NULL,'Good Camera',0),(100032,12000,33,1044,50026,'N',NULL,'lowest price',0),(100033,999,25,1029,50032,'N',NULL,'Black\r\nCotton',0),(100036,1400,10,1029,50036,'N','7C,8C,9C,10C,12C,13C,14,13','White',0),(100039,10,10,1029,50039,'N',NULL,'Filter 99.9% Bacteria',0),(100041,899,10,1029,50041,'N',NULL,'Series of three books',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3000262 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=50042 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (50026,'Galaxy M20',14999,2000007,'Product%2F50026-photo.png',3000088,'Samsung'),(50027,'Purse',1999.99,2000002,'Product%2F50027-photo.png',3000015,'Levi\'s'),(50029,'Baby powder',201,2000017,'Product%2F50029-photo.png',3000259,'Johnson & Johnson'),(50030,'Helmet',201,2000015,'Product%2F50030-photo.png',3000196,'Vega'),(50031,'Note 5 pro',15000,2000007,'Product%2F50031-photo.jpg',3000088,'Redmi'),(50032,'T shirt',1200,2000001,'Product%2F50032-photo.png',3000001,'Levi\'s'),(50033,'Shirt',2500,2000001,'Product%2F50033-photo.png',3000005,'Killer'),(50034,'T shirt',1200,2000001,NULL,3000001,'Killer'),(50035,'T shirt',1200,2000001,NULL,3000002,'Cotton King'),(50036,'Air',1499,2000003,'Product%2F50036-photo.png',3000022,'Nike'),(50037,'Physics',300,2000018,'Product%2F50037-photo.png',3000215,'NCERT'),(50038,'Canvas',1200,2000003,'Product%2F50038-photo.png',3000261,'Canva'),(50039,'N95 Mask',15,2000021,'Product%2F50039-photo.png',3000235,'Serum'),(50040,'Boot',1999,2000003,'Product%2F50040-photo.png',3000022,'Adidas'),(50041,'Meluha',999,2000018,'Product%2F50041-photo.jpg',3000216,'Amish ');
...
-- Dump completed on 2021-05-13 22:29:34
